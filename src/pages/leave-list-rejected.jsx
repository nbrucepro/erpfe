...
const LeaveListRejected = () => {
  ...
  return (
    <>    
      <Head>
        <title>{getPageTitle('LeaveList Rejected')}</title>
      </Head>
      <SectionMain>
      <section className={`mb-6 flex items-center justify-between`}>
      <div className="flex items-center justify-start">
        <IconRounded icon={mdiTableBorder} color="light" className="mr-3" bg />
        <h1 className={`leading-tight text-3xl`}>Leave List Rejected</h1>
      </div>
...
LeaveListRejected.getLayout = function getLayout(page) {
