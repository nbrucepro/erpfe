...
import PaidStatus from '../components/invoice/PaidStatus'
...
function InvoiceInfo({ onDelete }) {
    ...
    console.log("asPath - ");
    console.log(asPath);
    const invoiceId = asPath.split("?")[1]; 
    ...
    return (
        <div>
            {invoice ? <motion.div
                ...
                <div className=''>
                    ...
                    <button className=' flex items-center space-x-4  group  dark:text-white font-thin '
                    onClick={()=>{
                        router.back()  
                    }}
                    >
                    {/* <button onClick={() => navigate(-1)} className=' flex items-center space-x-4  group  dark:text-white font-thin '> */}
                        ...
                        <p>
                        <Pdf targetRef={ref} filename="Your-invoice.pdf">
        {({ toPdf }) => <button onClick={toPdf}>Export As PDF</button>}
                    ...
                    <div ref={ref} className=' mt-4 rounded-lg w-full  px-6 py-6 bg-white dark:bg-[#1e2139]'>
...
InvoiceInfo.getLayout = function getLayout(page) {
